...
- **scheduler d'annonce** (l'egress compte : l'agent DE annonce DEPUIS l'Allemagne, son propre Boréas/FOU)
...
- `secondary_stats` (dual-stack Boréas) devient **par-agent** sur les trackers qui somment par peer_id.
